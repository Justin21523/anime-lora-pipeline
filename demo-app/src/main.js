...
const project = {
  ...
  "githubUrl": "https://github.com/Justin21523/anime-lora-pipeline",
  ...
  "records": [
    {
      "id": "flow-01",
      "name": "Detected technical signals: Python, PyTorch, pandas,README evidence exists and can support a fuller reviewed case study,A public GitHub repository is linked for source traceability",
      "status": "Ready",
      "owner": "Frontend"
    },
    {
    ...
    {
      "id": "flow-03",
      "name": "Detected stack: Python, PyTorch, pandas",
      "status": "Queued",
      "owner": "Automation"
    }
  ]
